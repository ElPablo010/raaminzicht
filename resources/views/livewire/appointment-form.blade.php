        ...
        <form wire:submit="submit" class="rounded-3xl border border-primary-100 bg-white p-6 shadow-xl shadow-primary-950/5 sm:p-8">
            <div class="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input id="apt-phone" type="tel" wire:model="phone" autocomplete="tel" class="{{ $field }} @error('phone') {{ $fieldError }} @enderror" placeholder="{{ $this->txt('ph_phone', '04xx xx xx xx') }}">
