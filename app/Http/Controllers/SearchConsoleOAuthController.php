...
class SearchConsoleOAuthController extends Controller
{
    ...
    protected function authorizeAdmin(Request $request): void
    {
        ...
        // Projecten met klant-rollen (bv. scholen) hebben een isAdmin(); die
        // mogen wel in het panel maar niet aan de koppeling.
        abort_unless($user && $user->canAccessPanel($panel) && (! method_exists($user, 'isAdmin') || $user->isAdmin()), 403);
    }
