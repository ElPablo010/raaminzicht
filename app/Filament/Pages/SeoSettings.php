...
class SeoSettings extends Page
{
    ...
    public function mount(): void
    {
        ...
        $data['seo_weekly_report_enabled'] = (bool) $data['seo_weekly_report_enabled'];
        ...
        return $schema
            ->components([
                ...
                Section::make('Wekelijkse briefing')
                    ->description('De AI-key en de "feiten voor AI" staan op de algemene instellingenpagina. De briefing draait pas wanneer de schakelaar aan staat.')
                    ->schema([
                        Toggle::make('seo_weekly_report_enabled')
                            ->label('Wekelijkse AI-briefing actief')
                            ->helperText('Uit = geen wekelijkse AI-analyse, mail of actie-voorstellen (maandag 7:00). De cijfers verversen kun je altijd manueel doen op het Overzicht.')
                            ->columnSpanFull(),
