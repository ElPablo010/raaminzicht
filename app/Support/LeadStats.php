...
class LeadStats
{
    /** Zonder attributie-kolommen (migratie nog niet gedraaid) toont het scherm een melding. */
    public static function available(): bool
    {
        return Schema::hasTable('leads') && Schema::hasColumn('leads', 'channel');
    }
    ...
    {
        return self::distribution('type', $days, fn (?string $type) => Lead::TYPE_LABELS[$type] ?? ucfirst((string) $type));
    }
